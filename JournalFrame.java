...
class JournalFrame extends JFrame {
    ...
    public JournalFrame() {
        ...
        myDB = new DBConnector(info[0], info[1]);
        ...
        areaCodeField.addFocusListener(new JournalFocusListener());
        areaCodeField.getDocument().addDocumentListener(new JournalDocumentListner(areaCodeField, 3));

        prefixField.addFocusListener(new JournalFocusListener());
        prefixField.getDocument().addDocumentListener(new JournalDocumentListner(prefixField, 3));

        suffixField.addFocusListener(new JournalFocusListener());
        suffixField.getDocument().addDocumentListener(new JournalDocumentListner(suffixField, 4));
    ...
    public DBConnector getDBManager(){
        return myDB;
    }
